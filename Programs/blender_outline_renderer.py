...
data_file_path = "C:/Users/areil/Desktop/Terra/Programs/Program Outputs/test2-A1 AI formatted data.txt"     #Remember to use backslashes instead of forward slashes
