"""
Copy of pre_visualization_phase, but can be run from blender
"""
...
#Blender must take full paths

import sys

#Change variables below
path = 'C:/Users/areil/Desktop/Terra/Programs'                     #Path with all the programs. Remeber to use forwardslashes.
...
if input('Run AI segmentation model? (y/n)').lower() == 'y':
    ...
    output_dir="C:/Users/areil/Desktop/Terra/Programs/Program Outputs/test2-A1 AI segmentations"
    #---------------------
...
path_to_timepoints
    - Path to the directory where the AI segmented timepoint(s) are located. Input in the form: 'path_to_timepoints="*path*"'. Remember to replace backslashes with forwardslashes.
      This is most likely the output_dir of the AI SEGMENTATION phase. 
...
if input('\n\nRun AI segmentation formatter? (y/n)').lower() == 'y':
    ...
    #Change variables below
    output_file = "C:/Users/areil/Desktop/Terra/Programs/Program Outputs/test2-A1 AI formatted data.txt"

    path_to_timepoints="C:/Users/areil/Desktop/Terra/Programs/Program Outputs/test2-A1 AI segmentations"
    number_of_timepoints=46
    number_of_slices=15
